#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To Badboy
...
Afghan Nightmare Team

\033[1;91m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;95mBadboy\033[1;91m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"""                                 
jalan('\033[1;91m    Toll Update 100%   Welcome')
print "\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;91mBadboy\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"

CorrectUsername = "badboy"
CorrectPassword = "badboy"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:badboy
	    time.sleep(2)
            loop = 'false'
        else:
...
def login():
	...
	try:
		...
		jalan(' \033[1;91mWarning: \033[1;95mTermux  if you have any problem contact with me in telegram @your_nightmare_af' )                 
		print "\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬ •◈•\033[1;91mAfghan-Nightmare-Team\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https:www.facebook.com/profile.php?id=100027508358228')
...
def menu():
	...
	print "\033[1;91m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬ •◈•\033[1;95mBadboy\033[1;91m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬ •◈•"
...
def pilih_super():
	...
	p.map(main, id)
	print "\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;91mAfghan-Nightmare-Team\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
	print "  \033[1;91m«---•◈•---Developed By Badboy Afghan-Nightmare-Team Leader --•◈•---»" #Dev:badboy
	print '\033[1;93m✅Process Has Been Completed Press➡ Ctrl+Z.↩ Next Type (python2)↩\033[1;97m....'
...
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.
: \033[1;91m ....Badboy Afghan-Nightmare Team Leader....... \033[1;95m :
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.' 
                FACEBOOK
              \033[1;91m Badboy"""
